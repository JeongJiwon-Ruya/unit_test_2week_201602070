...
public class MockServiceTest {
    ...
    public void Log5_2(){
        ...
        champions.add((new Champion("가렌","미드",4)));
        champions.add((new Champion("가렌","미드",4)));
        champions.add((new Champion("가렌","미드",4)));
    ...
    @Test
    public void Log5_3(){
        when(mockService.findByName(anyString())).thenReturn(new Champion("럭스","탑",8));
    ...
    public void Log5_4(){
        ...
        champions.add(new Champion("쉔","탑",3));
